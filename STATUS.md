...
***1.2.50.54 is the ship.*** Caddy `handle_errors` Updating ReelOS page parses on Ubuntu Caddy 2.6.2 (53's `<<HTML` heredoc does not — Apply would leave `:80` dead). 53 overlay Copying house settings, byte %, Discover browse, lookupKey, Passengers Watch stay. Skip 49 (cloud-only #136). Prebuilt hashed UI, no Arena. Settings **Beta channel** still fetches **2.0.0** as a separate tarball. 1.2.51 parked. House is **1.2.50.52**. **Do not house-Apply until told.** Never twice.

## Stamp

- **VERSION / channel:** `1.2.50.54`
...
- **Base:** `main` at 1.2.50.53; Caddy 2.6-safe Updating page. 53 overlay heartbeat. 52 lookupKey. 51 Discover hide-owned / Passengers / splash / Continue watching. 50 OTA cleaner. 48 hands-off home. 47 request honesty. 1.2.50.46 hash titles. 1.2.50.45 Request. 1.2.50.43 Passengers. 1.2.50.42 hash-dump. 1.2.50.41 honesty. 1.2.50.40 door. 1.2.50.38 Library. 1.2.50.37 Discover.
...
```
python3 scripts/check-ota.py .   # ok version=1.2.50.54
