...
***1.2.50.55 is the ship.*** Collections (real TMDB franchises) and actor search on Home/Discover. 1.2.50.50 OTA cleaner stays. Library banner stays non-blocking. Skip 49 (cloud-only #136). 48 hands-off home stays. Prebuilt hashed UI, no Arena. Settings **Beta channel** still fetches **2.0.0** as a separate tarball. 1.2.51 parked. House live is **1.2.50.50** until this stamp is Applied. Never twice.
...
### Collections and actor search (1.2.50.55)

Home/Discover search people (actors) as well as movies and shows. Tap an actor for filmography with In library / Request / Watch. A title that belongs to a real TMDB collection (John Wick) opens that collection; parts say what is on the box. Request posts that title's TMDB id, not the person or collection. No invented box sets. Phone-first; poster art does not cover Request. Wizard stays 7 steps. Beta off is still movies/TV.
