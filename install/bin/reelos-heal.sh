...
#
#   curl -fsSL https://raw.githubusercontent.com/reelos-org/reelos/main/daemon/reelos-heal.sh | sudo bash
#
set -uo pipefail
...
APP="$ROOT/app"
RAW=https://raw.githubusercontent.com/reelos-org/reelos/main
