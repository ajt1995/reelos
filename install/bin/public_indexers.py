...
def apply_public_indexers(have_rows, schemas, post, log=None, enabled_names=None) -> list[str]:
    ...
    allowed = None if enabled_names is None else {str(name) for name in enabled_names}
    posted: list[str] = []
