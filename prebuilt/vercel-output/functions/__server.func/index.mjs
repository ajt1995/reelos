...
var grokOgIdentity = { "site": {
	"title": "ReelOS",
	"card": "custom",
	"description": "Install. Point. Stream. A cinematic Linux media-appliance OS.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_Mpy1k9 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_Mpy1k9
	};
	return ((_m, p) => {
		return {
			data,
