...
import { c as rememberCatalogTitles, n as HOSTNAME, o as getTitle, r as SOURCES, u as titleInCache } from "./appliance-BH_6H5H0.mjs";
import { A as Check, D as ChevronRight, E as Clapperboard, O as ChevronLeft, T as Cloud, _ as Layers, b as HardDrive, c as Search, g as Library, k as ChevronDown, m as LoaderCircle, r as TriangleAlert, s as Settings, w as Compass, y as House } from "../_libs/lucide-react.mjs";
import { _ as overlayLibraryPresence, b as titleForRequest, d as sourceLabel, g as mergeServerRequests, h as inFlightRequests, l as frontendLabel, p as useReelStore } from "./router-DvmzfdIa.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/gate-BI3T0Pqc.js
...
function Poster({ title, className, sizes = "poster" }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("relative overflow-hidden bg-card-2", sizes === "poster" ? "aspect-[2/3]" : "aspect-[16/9]", className),
		children: ok ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
			src: title.poster,
			alt: "",
			loading: "lazy",
			decoding: "async",
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					showCache ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						className: "absolute left-2 top-2 rounded-full bg-card px-2 py-0.5 text-[10px] font-medium tracking-wide text-circuit",
						children: "Cached"
					}) : null,
					status === "downloading" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "absolute inset-x-0 bottom-0 h-1 bg-background/40",
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							className: "h-full bg-circuit",
							style: { width: `${request?.progress ?? 0}%` }
						})
					}) : null,
					typeof progress === "number" && progress > 0 && progress < .97 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				...
				children: [
					...
					status === "downloading" ? request?.via === "cache" ? " · Cached" : ` · ${Math.round(request?.progress ?? 0)}%` : null,
...
function Row({ label, children }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
			className: "mb-2 font-display text-sm font-medium tracking-tight",
			children: label
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "no-scrollbar flex gap-3 overflow-x-auto pb-1.5",
			children
		})]
	});
}
var buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap font-medium transition-[background-color,box-shadow,color,transform,opacity] duration-150 ease-out disabled:pointer-events-none disabled:opacity-40 [&_svg]:pointer-events-none [&_svg]:shrink-0 focus-visible:outline-none focus-visible:shadow-[0_0_0_2px_var(--color-background),0_0_0_4px_var(--color-circuit)]", {
	variants: {
		variant: {
			...
			circuit: "bg-transparent text-circuit shadow-[var(--shadow-circuit)] hover:bg-circuit/10",
...
function HomeView() {
	...
	const [playMode, setPlayMode] = (0, import_react.useState)(null);
	...
	(0, import_react.useEffect)(() => {
		fetch("/api/performance", { cache: "no-store" }).then((r) => r.json()).then((j) => setPlayMode(j.mode === "direct" ? "DirectPlay" : j.mode === "vaapi" ? "VAAPI" : null)).catch(() => {});
	}, []);
	(0, import_react.useEffect)(() => {
		if (!booksOn) return;
		fetch("/api/books/library", { cache: "no-store" }).then((r) => r.json()).then((j) => setBookShelf(j.books || [])).catch(() => setBookShelf([]));
	}, [booksOn]);
	const catalogHits = [];
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
				...
				children: [
					...
					hits.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
						...
						children: hits.slice(0, 6).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							to: "/title/$id",
							params: { id: t.id },
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					playMode === "DirectPlay" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chip, {
						live: true,
						children: "DirectPlay"
					}) : playMode === "VAAPI" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Chip, {
						live: true,
						children: "VAAPI"
					}) : null
				]
			...
			}) : booksOn ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "mt-4 text-xs text-muted",
				children: [
					"Books is on. ",
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
						to: "/books",
						className: "text-circuit",
						children: "Search the catalogs"
					}),
			...
			shelf.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
				label: "On this box",
				children: shelf.slice(0, 24).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function Chip({ children, live, gold }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		className: cn("inline-flex h-7 items-center gap-1.5 rounded-full bg-card px-2.5 text-[11px] text-muted shadow-[var(--shadow-border)]", gold && "text-gold", live && "text-circuit"),
		children: [live ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-1.5 rounded-full bg-circuit" }) : null, children]
	});
}
...
function Wordmark({ className, markClassName, spinRing = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReelMark, {
			...
			className: "font-display text-[1.35rem] font-semibold tracking-[0.18em] text-foreground",
			children: "ReelOS"
		})]
	});
}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "font-display text-xs tracking-[0.22em] text-circuit uppercase",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
						...
						children: build.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(StatusDot, { status: s.status }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: cn("text-sm", s.status === "pending" && "text-faint", s.status === "running" && "text-circuit-bright", s.status === "done" && "text-foreground"),
									children: s.label
...
function StatusDot({ status }) {
	if (status === "done") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		className: "mt-0.5 flex size-5 items-center justify-center rounded-full bg-circuit text-background",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
			className: "size-3",
			strokeWidth: 3
		})
	});
	if (status === "running") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "mt-0.5 size-5 animate-spin text-circuit" });
...
function ApplyingBar() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "relative z-20 border-b border-circuit/35 bg-circuit/12 px-3 py-2",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
				className: "flex items-center gap-2 text-sm text-circuit-bright",
				children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
				to: "/settings",
				className: "mt-1 inline-block text-[12px] text-circuit",
				children: "Updates"
			})
		]
	});
...
function Shell({ children }) {
	...
	const watchUrl = typeof window !== "undefined" ? `http://${window.location.hostname}:8096` : "http://127.0.0.1:8096";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "relative min-h-dvh overflow-hidden bg-background",
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircuitFloor, { className: "fixed inset-0 z-0 opacity-80" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ApplyingBar, {}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "relative z-10 md:flex",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
					className: "hidden w-[200px] shrink-0 flex-col border-r border-border md:flex",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "flex items-center gap-2 px-4 py-3",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReelMark, { className: "size-6" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
							...
							children: NAV.map((n) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									to: n.to,
									className: cn("flex h-9 items-center gap-2.5 rounded-lg px-2.5 text-sm transition-colors duration-150", on ? "bg-card text-circuit" : "text-muted hover:bg-card/60 hover:text-foreground"),
									children: [
										...
										n.to === "/requests" && transferring > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "ml-auto font-mono text-[11px] text-circuit tabular-nums",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								...
								className: "mt-2 rounded-lg bg-raised px-2.5 py-2",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "font-mono text-[11px] text-faint",
									children: HOSTNAME
								}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
									className: "mt-1 flex items-center gap-1.5 text-[11px] text-circuit",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-1.5 rounded-full bg-circuit" }),
					...
					className: "flex min-w-0 flex-1 flex-col pb-12 md:pb-0",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						className: "flex items-center gap-2 px-3 pt-2 md:hidden",
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReelMark, { className: "size-6" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-display text-sm font-semibold tracking-[0.16em] text-foreground",
								children: "ReelOS"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								href: watchUrl,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
				className: "fixed inset-x-0 bottom-0 z-30 flex border-t border-border bg-background/92 backdrop-blur-md md:hidden",
				children: NAV.map((n) => {
					const on = n.to === "/" ? path === "/" : path.startsWith(n.to);
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: n.to,
						className: cn("relative flex h-12 flex-1 flex-col items-center justify-center gap-0.5 text-[10px]", on ? "text-circuit" : "text-faint"),
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(n.icon, { className: "size-4" }),
							n.label,
							n.to === "/requests" && transferring > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "absolute right-[18%] top-1 min-w-3.5 rounded-full bg-circuit px-1 text-[9px] font-medium text-background tabular-nums",
								children: transferring
							}) : null
						]
					}, n.to);
...
function Splash({ compact = false, warming = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(CircuitFloor, { className: "opacity-90" }),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "rise relative z-10",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Wordmark, {
					className: "flex-col gap-5",
					markClassName: "size-20",
					spinRing: showWarming && working
				})
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "rise rise-2 relative z-10 mt-6 font-display text-sm tracking-[0.34em] text-circuit uppercase",
			...
			showWarming ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
				...
				children: STEPS.map((step) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: cn("size-2 rounded-full", status === "ok" && "bg-circuit", status === "fail" && "bg-muted", status === "running" && "bg-circuit arena-pip-work", status === "pending" && "bg-faint/50") }), step.label]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-xs text-muted",
							children: stepLabel(status)
						})]
					}, step.id);
				})
				...
				className: "rise rise-3 relative z-10 mx-auto mt-4 max-w-md text-[15px] leading-relaxed text-muted",
				children: [
				...
				className: "rise rise-4 relative z-10 mt-8 flex flex-col items-center gap-3",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
					size: "lg",
					variant: "gold",
					onClick: begin,
...
function Wizard() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mx-auto w-full max-w-3xl px-4 pb-28 pt-3 md:px-8",
				children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("footer", {
				className: "fixed inset-x-0 bottom-0 z-20 border-t border-border bg-background/85 px-4 py-3 backdrop-blur-md md:px-10",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			kicker ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mb-1.5 font-display text-xs tracking-[0.22em] text-circuit uppercase",
				children: kicker
			}) : null,
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
...
function Card({ selected, onClick, children, className, disabled }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
		...
		disabled,
		onClick,
		className: cn("relative w-full rounded-xl p-3.5 text-left transition-[box-shadow,background-color,transform] duration-150 ease-out", selected ? "bg-circuit/8 shadow-[var(--shadow-circuit)]" : "bg-card shadow-[var(--shadow-border)] hover:shadow-[var(--shadow-border-hover)]", disabled && "opacity-45", className),
		children: [selected ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			className: "absolute right-3 top-3 flex size-5 items-center justify-center rounded-full bg-circuit text-background",
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
				className: "size-3.5",
				strokeWidth: 3
			})
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(o.icon, { className: cn("mt-0.5 size-5", mode === o.id ? "text-circuit" : "text-muted") }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
					...
					children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: cn("flex size-10 items-center justify-center rounded-lg font-display text-xs tracking-wide", answers.source === s.id ? "bg-circuit text-background" : "bg-card-2 text-muted"),
							children: s.mark
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
							className: "font-display font-medium",
							children: [s.name, blocked ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "ml-2 align-middle font-sans text-[11px] font-medium tracking-normal text-muted",
								children: "Untested"
							}) : null]
						}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-1 text-sm text-muted",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Heading, {
		...
		children: [
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				...
				className: cn("h-9 rounded-full px-4 text-sm font-medium transition-colors duration-150", on ? "bg-circuit/15 text-circuit shadow-[var(--shadow-circuit)]" : "bg-card text-muted shadow-[var(--shadow-border)]"),
				children: c.label
			}, c.key);
		})
	})] });
...
function Boot() {
	...
	if (provisioned) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Shell, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(HomeView, {}) });
