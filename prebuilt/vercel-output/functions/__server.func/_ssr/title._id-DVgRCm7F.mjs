...
import { A as requestTitleIdForPage, E as requestMediaTypeForPage, F as titlePresenceKeys, M as showRequestQueueControls, O as requestProgressLabel, P as titleMatchesId, _ as useReelStore, j as showHashAdapter, k as requestShowsRetry, n as Route, v as applyTitleRequestPoll } from "./router-BN1QAJlL.mjs";
import { a as formatRuntime, i as cn, n as Row, r as TitleCard, t as Poster } from "./title-card-B87ltnBM.mjs";
import { a as RemoveFromBox, i as Gate, n as Button, o as jellyfinWatchHref } from "./gate-CkPHXC_2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/title._id-DVgRCm7F.js
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: seasonNumbers.map((n) => {
				...
				const chip = seasonChipLabel({
					onDisk,
					importing: Boolean(importingSeasons?.includes(n)) && !onDisk,
					unreleased: Boolean(unreleasedSeasons?.includes(n)),
					removedHere
				});
...
function TitleView({ id }) {
	...
	const linkingSeasons = [...new Set([...importingSeasons || [], ...resolved.importingSeasons || []].map(Number).filter((n) => n > 0 && !diskSeasons.includes(n)))];
	const comingSeasons = [...new Set([
		...unreleasedSeasons || [],
