...
import { A as showHashAdapter, N as titleMatchesId, O as requestShowsRetry, P as titlePresenceKeys, T as requestMediaTypeForPage, _ as useReelStore, j as showRequestQueueControls, k as requestTitleIdForPage, n as Route, v as applyTitleRequestPoll } from "./router-BPo84ujE.mjs";
import { a as formatRuntime, i as cn, n as Row, r as TitleCard, t as Poster } from "./title-card-D_EBASBo.mjs";
import { a as RemoveFromBox, i as Gate, n as Button, o as jellyfinWatchHref } from "./gate-C9D7tlj1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/title._id-BdCFDxXK.js
...
function SeasonEpisodeAccordion({ seasonNumbers, selectedSeason, onSelectSeason, diskSeasons, importingSeasons, unreleasedSeasons, titleId, seasonsLoading, seasonErr, onRetrySeasons, blocked, removedHere, onRequestSeason, onRequestEpisode }) {
	...
	const showSeasonRequest = !blocked && !thisUnreleased && (removedHere || missing.length > 0 || open && !loading && episodes.length === 0);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				!loading && !episodes.length && !err && !thisUnreleased ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "py-3 text-sm text-muted",
