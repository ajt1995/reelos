...
//#region node_modules/.nitro/vite/services/ssr/assets/router-C4WO9IYb.js
...
var UPDATE_NOTES = [
	"1.2.50.57: Cloud 40×40 request loop. Unmonitored Sonarr seasons no longer refuse Request or paint Coming (Breaking Bad S02). Silo S04 / Rookie S09 stay Coming and do not SeasonSearch. Movie tmdb-<n> cannot POST as tmdb-tv-<n> (Dark Knight is not 3rd Rock). Skip 49. Do not house-Apply until told. Gold chrome, prebuilt hashed UI. 1.2.51 parked (was Tron chrome; scrapped — do not reuse).",
...
var styles_default = "/assets/styles-BpMpl5a6.css";
var APP_NAME = "ReelOS";
...
var $$splitComponentImporter$5 = () => import("./discover.shows-FeYGKhX1.mjs");
...
//#endregion
export { requestProgressLabel as A, catchupLocksHome as B, isGhostRequestLabel as C, overlayLibraryPresence as D, mergeServerRequests as E, titleForRequest as F, updateLocksUi as H, titleMatchesId as I, titlePresenceKeys as L, requestTitleIdForPage as M, showHashAdapter as N, requestMediaTypeForPage as O, showRequestQueueControls as P, transferringChipCount as R, inFlightRequests as S, isTvRequestRow as T, homeShelfRows as U, catchupShowsBanner as V, useReelStore as _, Route$4 as a, homeInFlightRequests as b, Route$8 as c, UPDATE_NOTES as d, accessLabel as f, storageLabel as g, sourceLabel as h, Route$3 as i, requestShowsRetry as j, requestNeedsLibraryHandoff as k, CHANNEL as l, qualityLabel as m, Route as n, Route$5 as o, frontendLabel as p, Route$2 as r, Route$6 as s, router_exports as t, SHIPPED_VERSION as u, applyTitleRequestPoll as v, isLinkedImportingRequest as w, importingSeasonNumbersForTitle as x, collapseHomeRequestCards as y, tvSeasonChips as z };
