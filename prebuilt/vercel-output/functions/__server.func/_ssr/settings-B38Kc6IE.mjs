...
import { H as catchupShowsBanner, _ as useReelStore, d as UPDATE_NOTES, f as accessLabel, g as storageLabel, h as sourceLabel, l as CHANNEL, m as qualityLabel, p as frontendLabel, u as SHIPPED_VERSION } from "./router-D4zanu1c.mjs";
import { a as cn, s as formatWhen } from "./title-card-HtBO2ET4.mjs";
import { i as Gate, n as Button } from "./gate-Ch-Nm4tu.mjs";
import { a as persistUi, i as Toggle, n as Section, r as TerminalRow, t as Row } from "./settings-terminal-C-k7eZii.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-B38Kc6IE.js
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThumbsDown, { className: "mt-0.5 size-4 text-faint" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-1 text-sm text-muted",
						children: ["Clears Likes and Not interested on Discover. Titles on this box stay on Home. No Google account.", count ? ` ${count} saved.` : ""]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						className: "mt-3",
						variant: "ghost",
