...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DQUzmDOi.js
...
var UPDATE_NOTES = [
	"1.2.50.52: Household profiles v1 (isolated continue/likes; kids hide adult and lock Request/Settings). Discover like/dislike, not Home library. Optional free Trakt OAuth; local thumbs work without it; reset curator per profile. Google TV has no supported taste API — honest Settings copy, no Sign in with Google. Fold into post-50-next 51+ if that bundle has not stamped. Never /media, never ota.lock. Do not house-Apply. Gold chrome, prebuilt hashed UI. 1.2.51 parked (was Tron chrome; scrapped — do not reuse).",
...
var styles_default = "/assets/styles-Dy36N5RZ.css";
var APP_NAME = "ReelOS";
