...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/router-Eei6X2k-.js
...
var UPDATE_NOTES = [
	"1.2.50.51: Honest Apply splash. Percent is tarball/extract bytes (or stage N of M + last heartbeat) — never a fake climbing 99%. Download 0 bytes for 2+ minutes says stalled. Splash copy is Tuning for 4GB RAM · spinning disk (4GB is RAM; disk type is separate; Settings keeps RAM / disk type / disk size distinct). Wizard stays 7 steps. No Arena. Skip 49 (cloud-only #136). Never /media, never ota.lock. Gold chrome, prebuilt hashed UI. 1.2.51 parked (was Tron chrome; scrapped — do not reuse).",
...
var styles_default = "/assets/styles-Bo4Y0Ns8.css";
var APP_NAME = "ReelOS";
