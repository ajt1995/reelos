...
import { A as showRequestQueueControls, D as requestShowsRetry, M as titleMatchesId, N as titlePresenceKeys, O as requestTitleIdForPage, T as requestMediaTypeForPage, _ as useReelStore, k as showHashAdapter, n as Route, v as applyTitleRequestPoll } from "./router-B8GRoBsn.mjs";
import { a as formatRuntime, i as cn, n as Row, r as TitleCard, t as Poster } from "./title-card-Dj2kEC1E.mjs";
import { a as RemoveFromBox, i as Gate, n as Button, o as jellyfinWatchHref } from "./gate-DSsyAQjm.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/title._id-1eXq2tCL.js
...
function SeasonEpisodeAccordion({ seasonNumbers, selectedSeason, onSelectSeason, diskSeasons, unreleasedSeasons, titleId, seasonsLoading, seasonErr, onRetrySeasons, blocked, removedHere, onRequestSeason, onRequestEpisode }) {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: seasonNumbers.map((n) => {
				...
				const chip = seasonChipLabel({
					onDisk: diskSeasons.includes(n) && !removedHere,
