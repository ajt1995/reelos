...
//#region node_modules/.nitro/vite/services/ssr/assets/router-D4zanu1c.js
...
function inFlightRequests(requests, opts = {}) {
	return overlayLibraryPresence(requests, opts).filter((r) => isInFlightRequest(r) || requestNeedsLibraryHandoff(r, opts));
}
...
function importingSeasonNumbersForTitle(titleId, requests, extraIds = []) {
...
*/
function homeInFlightRequests(requests, opts = {}) {
...
var UPDATE_NOTES = [
	"1.2.50.59: Discover and More like this have Like (thumbs up) and Not interested (thumbs down). Like persists on this box and boosts similar titles in Discover. Dislike hides from Discover only — Home and Library keep owned titles. Settings Reset curator preferences clears both. Phone-sized tap targets sit on the poster, not under it. No Google. Gold chrome, prebuilt hashed UI. Beta off. Skip 49. Do not house-Apply until told. 1.2.51 parked (was Tron chrome; scrapped — do not reuse).",
...
var useReelStore = create()(persist((set, get) => ({
	...
	applyReadyPayload: (ready) => {
		...
		set((s) => {
			...
			const requests = overlayLibraryPresence(mergeServerRequests(s.requests, live), { titles: shelf });
...
var styles_default = "/assets/styles-Bc2BrJkZ.css";
var APP_NAME = "ReelOS";
...
var $$splitComponentImporter$16 = () => import("./routes-Is5rmcjU.mjs");
var Route$16 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$16, "component") });
var $$splitComponentImporter$15 = () => import("./activity-C4pwxtI-.mjs");
var Route$15 = createFileRoute("/activity")({ component: lazyRouteComponent($$splitComponentImporter$15, "component") });
var $$splitComponentImporter$14 = () => import("./books-CMrLg6Xd.mjs");
var Route$14 = createFileRoute("/books")({ component: lazyRouteComponent($$splitComponentImporter$14, "component") });
var $$splitComponentImporter$13 = () => import("./connect-BuVYMS6P.mjs");
var Route$13 = createFileRoute("/connect")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("./discover-DRZHwZLV.mjs");
var Route$12 = createFileRoute("/discover")({ component: lazyRouteComponent($$splitComponentImporter$12, "component") });
var $$splitComponentImporter$11 = () => import("./library-CTe1iLgc.mjs");
var Route$11 = createFileRoute("/library")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./requests-WowMN1-0.mjs");
var Route$10 = createFileRoute("/requests")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("./settings-B38Kc6IE.mjs");
var Route$9 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./collection._id-6LhB-HWB.mjs");
var Route$8 = createFileRoute("/collection/$id")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./discover.index-CqFo3hmi.mjs");
var Route$7 = createFileRoute("/discover/")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./discover.movies-D_J8tt1B.mjs");
...
var $$splitComponentImporter$5 = () => import("./discover.shows-D5z2PWT1.mjs");
...
var $$splitComponentImporter$4 = () => import("./engine._id-C1G9w17T.mjs");
var Route$4 = createFileRoute("/engine/$id")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./person._id-DF58H_go.mjs");
var Route$3 = createFileRoute("/person/$id")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./play._id-cl0xJ7vS.mjs");
var Route$2 = createFileRoute("/play/$id")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./settings.advanced-DVr1kEKa.mjs");
var Route$1 = createFileRoute("/settings/advanced")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./title._id-BQnyEpim.mjs");
...
var ActivityRoute = Route$15.update({
	id: "/activity",
	path: "/activity",
	getParentRoute: () => Route$17
});
var BooksRoute = Route$14.update({
	id: "/books",
	path: "/books",
	getParentRoute: () => Route$17
});
var ConnectRoute = Route$13.update({
	id: "/connect",
	path: "/connect",
	getParentRoute: () => Route$17
});
...
var RequestsRoute = Route$10.update({
	id: "/requests",
	path: "/requests",
	getParentRoute: () => Route$17
});
...
//#endregion
export { requestProgressLabel as A, tvSeasonChips as B, isGhostRequestLabel as C, overlayLibraryPresence as D, mergeServerRequests as E, titleForRequest as F, catchupShowsBanner as H, titleHasRemotePoster as I, titleMatchesId as L, requestTitleIdForPage as M, showHashAdapter as N, requestMediaTypeForPage as O, showRequestQueueControls as P, titlePresenceKeys as R, inFlightRequests as S, isTvRequestRow as T, updateLocksUi as U, catchupLocksHome as V, homeShelfRows as W, useReelStore as _, Route$4 as a, homeInFlightRequests as b, Route$8 as c, UPDATE_NOTES as d, accessLabel as f, storageLabel as g, sourceLabel as h, Route$3 as i, requestShowsRetry as j, requestNeedsLibraryHandoff as k, CHANNEL as l, qualityLabel as m, Route as n, Route$5 as o, frontendLabel as p, Route$2 as r, Route$6 as s, router_exports as t, SHIPPED_VERSION as u, applyTitleRequestPoll as v, isLinkedImportingRequest as w, importingSeasonNumbersForTitle as x, collapseHomeRequestCards as y, transferringChipCount as z };
