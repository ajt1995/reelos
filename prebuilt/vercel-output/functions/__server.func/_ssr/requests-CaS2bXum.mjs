...
import { d as viaLabel, o as getTitle } from "./appliance-BH_6H5H0.mjs";
import { b as titleForRequest, h as inFlightRequests, p as useReelStore, v as requestShowsRetry } from "./router-DvmzfdIa.mjs";
import { d as formatWhen, f as useSyncRequests, i as Gate, l as cn, n as Button } from "./gate-BI3T0Pqc.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/requests-CaS2bXum.js
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: FILTERS.map((f) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: cn("h-7 rounded-full px-3 text-xs", filter === f.id ? "bg-circuit/20 text-circuit" : "bg-card text-muted shadow-[var(--shadow-border)]"),
					children: f.label
				}, f.id))
			}),
