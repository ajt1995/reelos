...
import { f as Search, j as ChevronRight } from "../_libs/lucide-react.mjs";
import { F as titleForRequest, _ as useReelStore, b as homeInFlightRequests, y as collapseHomeRequestCards } from "./router-D4zanu1c.mjs";
import { i as TitleCard, r as Row } from "./title-card-HtBO2ET4.mjs";
import { n as useSyncRequests, t as useResolveGhostRequestTitles } from "./use-sync-requests-oZcXhQng.mjs";
import { i as useCurator, r as titleIsCuratorLiked, t as filterCuratorHidden } from "./use-curator-tR6hZE93.mjs";
import { t as filterDiscoverCatalog } from "./discover-owned-CmaIdKQi.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/discover.index-CqFo3hmi.js
...
function DiscoverView() {
	...
	const voteDiscover = (title, vote) => {
		...
		if (vote === "like") fetch("/api/discover", { cache: "no-store" }).then((res) => res.json()).then((r) => {
			const movies = Array.isArray(r?.movies) ? r.movies : [];
			const tv = Array.isArray(r?.tv) ? r.tv : [];
			rememberCatalogTitles([...movies, ...tv]);
			rememberTitles?.([...movies, ...tv]);
...
function DiscoverKind({ heading, to, finishing, pick, likedIds, hiddenIds, onVote }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "mt-10",
		children: [
