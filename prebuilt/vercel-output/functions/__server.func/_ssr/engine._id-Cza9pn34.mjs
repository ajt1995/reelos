...
import { d as viaLabel, i as adapterProfile, o as getTitle } from "./appliance-CsV_BBL_.mjs";
import { I as ArrowLeft } from "../_libs/lucide-react.mjs";
import { d as sourceLabel, i as Route$3, p as useReelStore } from "./router-DBwfHMvx.mjs";
import { i as Gate, n as Button } from "./gate-KSzUs2Be.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/engine._id-Cza9pn34.js
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: r.status === "downloading" ? `${Math.round(r.progress)}%` : "search"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("table", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("thead", {
				...
				const status = library.includes(r.id) ? "Imported" : req?.status === "downloading" ? `${Math.round(req.progress)}%` : req?.status ?? "Missing";
