...
import { c as rememberCatalogTitles, n as HOSTNAME, o as getTitle, r as SOURCES, u as titleInCache } from "./appliance-DZSyqH7A.mjs";
...
import { _ as overlayLibraryPresence, b as titleForRequest, d as sourceLabel, g as mergeServerRequests, h as inFlightRequests, l as frontendLabel, p as useReelStore } from "./router-Dz7ZmWyw.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/gate-CFzR9JKr.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ReelMark, { className: "size-7" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "font-display text-sm font-semibold tracking-[0.18em] text-gold",
								children: "ReelOS"
							})]
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
							...
							children: NAV.map((n) => {
								...
								return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
									to: n.to,
									className: cn("flex h-11 items-center gap-3 rounded-xl px-3 text-sm transition-colors duration-150", on ? "bg-card text-foreground" : "text-muted hover:bg-card/60 hover:text-foreground"),
									children: [
										...
										n.to === "/requests" && transferring > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
											className: "ml-auto font-mono text-[11px] text-gold tabular-nums",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Clapperboard, { className: "size-4" }), "Watch"]
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									className: "mt-1 flex items-center gap-1.5 text-[11px] text-live",
									children: [
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
				...
				children: NAV.filter((n) => n.to !== "/activity").map((n) => {
					const on = n.to === "/" ? path === "/" : path.startsWith(n.to);
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
						to: n.to,
						className: cn("flex h-16 flex-1 flex-col items-center justify-center gap-1 text-[11px]", on ? "text-gold" : "text-faint"),
...
function StepSource() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: SOURCES.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Card, {
		...
		answers.source === "local-vpn" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mt-6",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
				...
				children: [
					...
					className: cn("h-10 rounded-xl capitalize", answers.vpnProvider === v ? "bg-gold text-gold-fg" : "bg-card text-muted shadow-[var(--shadow-border)]"),
					children: v
				}, v))
			})]
		}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				ok === false && err ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
function StepFrontend() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			className: "grid gap-3",
			children: opts.map((o) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Card, {
		...
		needsClaim ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mt-6",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", {
					className: "text-sm text-muted",
					children: "Plex claim token"
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1 text-xs text-faint",
					children: "Open plex.tv/claim in another tab. Paste the token. It expires quickly."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
...
function StepAccess() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
		...
		answers.access === "cloudflare" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
			className: "mt-6 block",
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
				className: "text-sm text-muted",
				children: "Tunnel token"
			}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
