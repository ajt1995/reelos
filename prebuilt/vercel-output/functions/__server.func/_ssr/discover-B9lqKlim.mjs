...
import { D as titleForRequest, _ as collapseHomeRequestCards, h as useReelStore, v as inFlightRequests } from "./router-DJXQsDxk.mjs";
import { c as TitleCard, i as Gate, m as useSyncRequests, s as Row } from "./gate-hkGl6LFk.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/discover-B9lqKlim.js
...
function installHonestRequest() {
	useReelStore.setState({ requestTitle: (titleId, season) => {
		...
		const requester = s.users.find((u) => u.id === s.activeProfileId)?.name ?? s.users.find((u) => u.role === "owner" || u.role === "admin")?.name ?? "Ada";
			...
			q.trim().length >= 2 ? hits.length > 0 || peopleHits.length > 0 || collectionHits.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
				peopleHits.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "mb-3 font-display text-lg font-medium tracking-tight",
						children: "People"
						...
						children: peopleHits.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [
								...
								}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "size-10 rounded-full bg-card-2" }),
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						...
						children: collectionHits.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Link, {
							...
							children: [
								...
								}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "h-14 w-10 rounded bg-card-2" }),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
									className: "flex-1 truncate",
									children: c.name
								}),
...
function DiscoverKind({ heading, finishing, pick, onHide }) {
