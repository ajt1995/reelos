...
import { a as CHANNEL, c as accessLabel, d as sourceLabel, f as storageLabel, l as frontendLabel, o as SHIPPED_VERSION, p as useReelStore, s as UPDATE_NOTES, u as qualityLabel } from "./router-DstgBgqY.mjs";
import { d as formatWhen, i as Gate, l as cn, n as Button } from "./gate-B6Ld30lK.mjs";
import { a as persistUi, i as Toggle, n as Section, r as TerminalRow, t as Row } from "./settings-terminal-KmPyLdWN.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/settings-CGJM0Xa6.js
...
function UpdatesRow({ open, onClick }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Row, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-2 text-sm text-muted",
				children: update.status === "applying" ? "An Apply is running — phone, CLI, or both. Home can open. Engines are still configuring. Do not tap Apply again." : libraryCatchup.status === "running" || libraryCatchup.status === "backoff" ? "The update is on this box. Library catch-up is still importing dumps — folder skips and timeouts are here, not a stuck Apply." : "Host patches from Ubuntu, ReelOS from GitHub. Stack images stay frozen unless you flip the toggle. Libraries stay put."
			}),
			libraryCatchup.status === "running" || libraryCatchup.status === "backoff" ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
