...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BRdtnWtf.js
...
function homeShelfRows(titles) {
	...
	const named = list.filter((t) => !isHashDumpCard(t) && t.title && t.title !== "Unknown on this box" && !looksLikeHashTitle(t.title));
...
var UPDATE_NOTES = [
	"1.2.50.54: Caddy handle_errors Updating ReelOS page parses on Ubuntu Caddy 2.6.2 (no <<HTML heredoc). Apply of 53 would copy a Caddyfile 2.6 cannot load and leave :80 dead. Overlay Copying house settings, byte % only with bytes, Discover browse, lookupKey, Passengers Watch stay. Do not house-Apply until told. Gold chrome, prebuilt hashed UI. 1.2.51 parked (was Tron chrome; scrapped — do not reuse).",
...
var styles_default = "/assets/styles-Ddo3HRqb.css";
var APP_NAME = "ReelOS";
...
var $$splitComponentImporter$5 = () => import("./discover.shows-COFae5sh.mjs");
...
//#endregion
export { showRequestQueueControls as A, mergeServerRequests as C, requestShowsRetry as D, requestNeedsLibraryHandoff as E, tvSeasonChips as F, catchupLocksHome as I, catchupShowsBanner as L, titleMatchesId as M, titlePresenceKeys as N, requestTitleIdForPage as O, transferringChipCount as P, updateLocksUi as R, isTvRequestRow as S, requestMediaTypeForPage as T, useReelStore as _, Route$4 as a, inFlightRequests as b, Route$8 as c, UPDATE_NOTES as d, accessLabel as f, storageLabel as g, sourceLabel as h, Route$3 as i, titleForRequest as j, showHashAdapter as k, CHANNEL as l, qualityLabel as m, Route as n, Route$5 as o, frontendLabel as p, Route$2 as r, Route$6 as s, router_exports as t, SHIPPED_VERSION as u, applyTitleRequestPoll as v, overlayLibraryPresence as w, isGhostRequestLabel as x, collapseHomeRequestCards as y, homeShelfRows as z };
