...
import { A as Clapperboard, C as House, I as BookOpen, M as ChevronLeft, N as ChevronDown, O as Compass, P as Check, a as TriangleAlert, b as Library, d as Settings, f as Search, j as ChevronRight, k as Cloud, v as LoaderCircle, w as HardDrive, x as Layers, z as Activity } from "../_libs/lucide-react.mjs";
import { A as updateLocksUi, E as titleMatchesId, O as transferringChipCount, T as titleForRequest, _ as isGhostRequestLabel, d as sourceLabel, g as inFlightRequests, h as collapseHomeRequestCards, k as catchupLocksHome, l as frontendLabel, p as useReelStore, v as mergeServerRequests, y as overlayLibraryPresence } from "./router-DQUzmDOi.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/gate-CTesRm1X.js
...
var GOOGLE_TV_COPY = "Google TV has no supported taste or watch-history API. ReelOS will not Sign in with Google and will not scrape Google. Use thumbs on Discover, or optional free Trakt.";
var empty$1 = {
	picker: false,
	activeId: "p-admin",
	profile: null,
	...
	traktCopy: "Trakt is free. VIP is optional paid extras we do not need. Local like/dislike works with Trakt disconnected. Connect only if you want ratings synced.",
	traktConfigured: false
};
function isKidsProfile(p) {
	return Boolean(p?.kind === "kids" || p?.parental?.lockRequest || p?.parental?.lockSettings);
}
function useHouseholdProfile() {
	const [state, setState] = (0, import_react.useState)(empty$1);
	const refresh = (0, import_react.useCallback)(() => {
		fetch("/api/profiles", { cache: "no-store" }).then((r) => r.json()).then((j) => {
			setState({
				...
				googleTv: j.googleTv || {
					supported: false,
					copy: "Google TV has no supported taste or watch-history API. ReelOS will not Sign in with Google and will not scrape Google. Use thumbs on Discover, or optional free Trakt."
				},
				traktCopy: j.trakt?.copy || "Trakt is free. VIP is optional paid extras we do not need. Local like/dislike works with Trakt disconnected. Connect only if you want ratings synced.",
	...
	const select = (0, import_react.useCallback)(async (id) => {
	...
	const vote = (0, import_react.useCallback)(async (titleId, next) => {
		const j = await (await fetch("/api/curator", {
			method: "POST",
			headers: { "Content-Type": "application/json" },
			body: JSON.stringify({
				titleId,
	...
	return {
		...
		select,
		vote,
		kids: isKidsProfile(state.profile)
	};
}
...
function HomeView() {
	...
	const continueWatch = Object.entries({
		...watch,
		...continueWatching
	}).filter(([, v]) => v > .03 && v < .96).map(([id, v]) => ({
		t: getTitle(id),
		v
	})).filter((x) => x.t && library.includes(x.t.id)).filter((x) => !(kids && x.t && (x.t.adult || (x.t.genres || []).some((g) => /adult|erotic|nc-17/i.test(g)))));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			shelf.filter((t) => !(kids && (t.adult || (t.genres || []).some((g) => /adult|erotic|nc-17/i.test(g))))).length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
				label: "On this box",
				children: shelf.filter((t) => !(kids && (t.adult || (t.genres || []).some((g) => /adult|erotic|nc-17/i.test(g))))).slice(0, 24).map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "w-[148px] shrink-0 sm:w-[168px]",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TitleCard, {
						title: t,
						className: "w-auto"
					}), kids ? null : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RemoveFromBox, {
						title: t,
						compact: true
					})]
				}, t.id))
...
function ProfileSwitcher({ compact = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		className: cn("flex items-center gap-1", compact && "overflow-x-auto"),
		children: profiles.map((p) => {
			const on = p.id === profile?.id;
			return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				type: "button",
				onClick: () => void select(p.id),
				className: cn("h-8 shrink-0 rounded-full px-3 text-xs", on ? "bg-gold text-gold-fg" : "bg-card-2 text-muted"),
				children: [p.name, p.kind === "kids" ? " · kids" : ""]
			}, p.id);
		})
	});
}
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: "px-3 pb-3",
							children: [
								watchHref ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
									href: watchHref,
									target: "_blank",
									rel: "noreferrer",
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
									className: "px-3 pb-2",
									children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProfileSwitcher, {})
								})
							]
						})
					]
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
							...
							children: [
								...
								arena && !kids ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Link, {
									to: "/settings",
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProfileSwitcher, { compact: true })
						}),
...
//#endregion
export { Gate as a, Row as c, formatRuntime as d, formatWhen as f, useSyncRequests as g, useResolveGhostRequestTitles as h, GOOGLE_TV_COPY as i, TitleCard as l, useHouseholdProfile as m, Button as n, Poster as o, jellyfinWatchHref as p, ConnectView as r, RemoveFromBox as s, Boot as t, cn as u };
