...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-CrgdsyOO.mjs");
...
var manifest = {
	"258f0c1890e4544d82619f31600079d1a054c2e11b8af15418d099f7d01f07e0": {
		...
		importer: () => import("./appliance-BH_6H5H0.mjs")
	},
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-DvmzfdIa.mjs").then((n) => n.t),
