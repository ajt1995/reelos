...
//#region node_modules/.nitro/vite/services/ssr/assets/adapter-jxU21cqA.js
var SOURCES = [
	{
		id: "torbox",
		name: "TorBox",
		blurb: "Cloud debrid. STRM for Jellyfin, FUSE for Plex.",
		mark: "TB"
	},
	{
		id: "real-debrid",
		name: "Real-Debrid",
		blurb: "Cached torrents into a virtual library.",
		mark: "RD"
	},
	{
		id: "alldebrid",
		name: "AllDebrid",
		blurb: "Same class of cloud unlock as Real-Debrid.",
		mark: "AD"
	},
	{
		id: "premiumize",
		name: "Premiumize",
		blurb: "Cloud transfer plus a hosted library.",
		mark: "PM"
	},
	{
		id: "local-vpn",
		name: "Local + VPN",
		blurb: "qBittorrent behind Gluetun. Killswitch on.",
		mark: "LN"
	}
];
...
//#endregion
//#region node_modules/.nitro/vite/services/ssr/assets/appliance-DZSyqH7A.js
