...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/router-3T_H3b8c.js
...
var UPDATE_NOTES = [
	"1.2.50.55: Collections and actor search. Home/Discover search people (actors) as well as movies and shows — tap an actor for filmography with In library / Request / Watch. A title that belongs to a real TMDB collection (John Wick) opens that collection; parts say what's on the box. Request posts that title's TMDB id, not the person or collection. No invented box sets. Phone-first; poster art does not cover Request. Wizard stays 7 steps. Beta off is still movies/TV. Gold chrome, prebuilt hashed UI. 1.2.51 parked (was Tron chrome; scrapped — do not reuse).",
...
var styles_default = "/assets/styles-DQFDasKQ.css";
var APP_NAME = "ReelOS";
...
//#endregion
export { transferringChipCount as A, requestShowsRetry as C, titleForRequest as D, showRequestQueueControls as E, updateLocksUi as M, titleMatchesId as O, requestMediaTypeForPage as S, showHashAdapter as T, collapseHomeRequestCards as _, Route$4 as a, mergeServerRequests as b, SHIPPED_VERSION as c, frontendLabel as d, qualityLabel as f, applyTitleRequestPoll as g, useReelStore as h, Route$3 as i, catchupLocksHome as j, titlePresenceKeys as k, UPDATE_NOTES as l, storageLabel as m, Route as n, Route$5 as o, sourceLabel as p, Route$2 as r, CHANNEL as s, router_exports as t, accessLabel as u, inFlightRequests as v, requestTitleIdForPage as w, overlayLibraryPresence as x, isGhostRequestLabel as y };
