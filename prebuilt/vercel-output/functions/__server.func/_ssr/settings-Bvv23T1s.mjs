...
import { C as House, D as Cpu, L as Bell, P as Check, S as KeyRound, a as TriangleAlert, j as ChevronRight, l as SlidersHorizontal, m as RefreshCw, n as Wrench, p as ScrollText, r as Users, s as ThumbsDown, u as Shield, v as LoaderCircle, w as HardDrive } from "../_libs/lucide-react.mjs";
import { F as OWNER_PERMISSION_TOGGLES, I as isHouseOwner, c as SHIPPED_VERSION, d as frontendLabel, f as qualityLabel, h as useReelStore, j as catchupLocksHome, l as UPDATE_NOTES, m as storageLabel, p as sourceLabel, s as CHANNEL, u as accessLabel } from "./router-DJXQsDxk.mjs";
import { d as formatWhen, i as Gate, l as cn, n as Button } from "./gate-hkGl6LFk.mjs";
import { a as persistUi, i as Toggle, n as Section, r as TerminalRow, t as Row } from "./settings-terminal-K3gVR_DN.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/settings-Bvv23T1s.js
...
function UsersPanel() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			className: "text-sm text-muted",
			children: "Each person has their own 1–2 question setup. ReelOS uses that Jellyfin user. The owner sets roles here."
		}),
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			...
			children: users.map((u) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					className: "rounded-xl bg-card-2 px-3 py-2",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								children: isHouseOwner(u.role) ? "owner" : "member"
							}),
							u.id === activeId ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "ml-2 text-gold",
								children: "this phone"
							}) : null
						] }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
							className: "text-xs text-muted",
							children: u.jellyfinUser || u.name
						})]
					}), openId === u.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						className: "mt-2 border-t border-border pt-2",
						children: owner ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [OWNER_PERMISSION_TOGGLES.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							className: "mt-2 flex items-center justify-between gap-3 text-sm",
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [t.label, /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						}, t.id)), !isHouseOwner(u.role) ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
							type: "button",
							className: "mt-3 text-xs text-danger",
							onClick: () => {
								fetch(`/api/profiles/${encodeURIComponent(u.id)}`, { method: "DELETE" }).then(() => removeUser(u.id));
							},
							children: "Remove"
						}) : null] }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-xs text-muted",
							children: "Only the owner can change roles and permissions."
						})
					}) : null]
				}, u.id);
			})
		...
		owner ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			children: "Add someone from the profile picker — two questions, not the house wizard."
		}) : null,
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
			className: "mt-3",
			size: "sm",
		...
		owner ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThumbsDown, { className: "mt-0.5 size-4 text-faint" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
						className: "mt-1 text-sm text-muted",
						children: ["Clears Not interested titles on Discover for this profile. Titles on this box stay on Home. No Google account.", count ? ` ${count} hidden.` : ""]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						className: "mt-3",
						variant: "ghost",
