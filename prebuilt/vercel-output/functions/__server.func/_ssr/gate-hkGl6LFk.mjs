...
import { A as Clapperboard, C as House, I as BookOpen, M as ChevronLeft, N as ChevronDown, O as Compass, P as Check, a as TriangleAlert, b as Library, d as Settings, f as Search, j as ChevronRight, k as Cloud, s as ThumbsDown, v as LoaderCircle, w as HardDrive, x as Layers, z as Activity } from "../_libs/lucide-react.mjs";
import { A as transferringChipCount, D as titleForRequest, I as isHouseOwner, M as updateLocksUi, N as AGE_BANDS, O as titleMatchesId, P as MEMBER_WIZARD_QUESTIONS, _ as collapseHomeRequestCards, b as mergeServerRequests, d as frontendLabel, h as useReelStore, j as catchupLocksHome, p as sourceLabel, v as inFlightRequests, x as overlayLibraryPresence, y as isGhostRequestLabel } from "./router-DJXQsDxk.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/gate-hkGl6LFk.js
...
function ProfileWizard({ onDone, onBack }) {
	const [step, setStep] = (0, import_react.useState)(1);
	const [band, setBand] = (0, import_react.useState)(null);
	...
	const can = step === 1 ? Boolean(band) : username.trim().length >= 2 && pin.length >= 4;
	const finish = async () => {
		setErr("");
		setBusy(true);
		try {
			const j = await (await fetch("/api/profiles/setup", {
				method: "POST",
				headers: { "Content-Type": "application/json" },
				body: JSON.stringify({
					ageBand: band,
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					step === 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: AGE_BANDS.map((b) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							type: "button",
							onClick: () => setBand(b.id),
							className: cn("relative w-full rounded-2xl p-5 text-left transition-[box-shadow,background-color] duration-150", band === b.id ? "bg-gold/8 shadow-[var(--shadow-gold)]" : "bg-card shadow-[var(--shadow-border)] hover:shadow-[var(--shadow-border-hover)]"),
							children: [
								band === b.id ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								...
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: b.parentalMax == null ? "No parental cap on this account." : `Jellyfin parental max ${b.parentalMax}.`
								})
							]
						}, b.id))
					}) : /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: "Existing Jellyfin users sign in. New names are created on this box."
							})
						]
					}),
					err ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("footer", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
						...
						children: [
							busy ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "size-4 animate-spin" }) : null,
...
function ProfilePicker() {
	...
	if (adding) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProfileWizard, {
		onBack: () => setAdding(false),
		onDone: () => {
			setAdding(false);
		}
	});
	const signIn = async (profile, password) => {
		setErr("");
		setBusy(true);
		try {
			const j = await (await fetch("/api/profiles/session", {
				method: "POST",
				headers: { "Content-Type": "application/json" },
				body: JSON.stringify({
					id: profile.id,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
				className: "flex items-center justify-between px-6 py-5 md:px-10",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Wordmark, { markClassName: "size-7" })
			}),
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "mx-auto w-full max-w-3xl px-6 pb-16 pt-4 md:px-8",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						className: "mb-8 rise",
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "mt-3 max-w-xl text-[15px] leading-relaxed text-muted",
								children: "ReelOS signs in as your Jellyfin user, not the owner's. Likes stay on this profile. Trakt is optional."
							})
						]
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: users.map((u) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
							...
							className: cn("relative w-full rounded-2xl p-5 text-left shadow-[var(--shadow-border)]", picked?.id === u.id ? "bg-gold/8 shadow-[var(--shadow-gold)]" : "bg-card"),
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "font-display text-lg font-medium",
								children: u.name
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "mt-1 text-sm text-muted",
								children: [isHouseOwner(u.role) ? "Owner" : "Member", u.jellyfinUser ? ` · ${u.jellyfinUser}` : ""]
							})]
						}, u.id))
					}),
					picked ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
								className: "text-sm text-muted",
								children: "Jellyfin password or PIN"
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
								type: "password",
								autoComplete: "current-password",
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						...
						children: "Two questions. Age, then their Jellyfin login. Not the 7-step house wizard."
					})
				]
			})
		]
						...
						jfLock ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								...
								children: [
									...
									box.adminPassword ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
										" ",
										"· PIN ",
										/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", {
					className: "hidden w-[220px] shrink-0 flex-col border-r border-border md:flex",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", {
						className: "flex items-center gap-3 px-4 pt-4 md:hidden",
						children: [
							...
							watchHref ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
								...
								target: "_blank",
								rel: "noreferrer",
								className: cn("ml-auto flex h-11 items-center rounded-xl px-3 text-sm font-medium text-gold", arena && "h-8 rounded-full bg-gold px-3 text-xs text-gold-fg arena-gold-press"),
								children: "Watch"
...
function Gate({ children, chrome = true }) {
	...
	if (profileReady && !activeProfileId) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProfilePicker, {});
...
//#endregion
export { Poster as a, TitleCard as c, formatWhen as d, jellyfinWatchHref as f, Gate as i, cn as l, useSyncRequests as m, Button as n, RemoveFromBox as o, useResolveGhostRequestTitles as p, ConnectView as r, Row as s, Boot as t, formatRuntime as u };
