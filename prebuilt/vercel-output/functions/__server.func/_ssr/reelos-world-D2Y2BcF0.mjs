...
import { A as ShieldCheck, Bt as Bookmark, C as Sparkles, Ct as Compass, D as SlidersHorizontal, Dt as Clock3, F as RotateCcw, Ft as Check, Gt as ArrowLeft, H as Play, Ht as BookOpen, J as MonitorSmartphone, K as Moon, L as RefreshCw, Mt as ChevronRight, N as Search, Nt as ChevronLeft, O as ShoppingBag, Pt as ChevronDown, Q as MessageCircle, R as Radio, S as Speaker, St as Copy, T as Smartphone, U as Pause, Ut as AudioLines, V as Plus, Vt as BookmarkCheck, _t as Film, b as Sun, bt as Download, c as UsersRound, dt as Heart, f as Upload, ft as HardDrive, gt as Flame, h as TriangleAlert, i as WandSparkles, it as Library, m as Tv, n as X, nt as LoaderCircle, o as Volume2, p as Type, pt as Gauge, q as MonitorUp, rt as ListTree, s as Users, u as UserRound, ut as House, v as ThumbsDown, wt as Coffee, x as SunMedium, y as Tag, yt as ExternalLink, zt as BrainCircuit } from "../_libs/lucide-react.mjs";
import { C as TITLES, E as cn, X as useReelStore, _ as publicPlaybackPath, b as sourcesForExperienceTitle, f as resolveCompanionSeed, h as isDebridConnected, u as Button, v as sourceForLookupTitle, x as titleCanUseProvider, y as sourceIsAccessible } from "./router-M-yvs45k.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/reelos-world-D2Y2BcF0.js
...
function resolveTmdbIdentity(titleId, kind, extraIds = []) {
	...
	for (const c of candidates) {
		...
		if (tvMatch) return {
			mediaType: "tv",
			externalId: tvMatch[1]
		};
		const movieMatch = /^tmdb-(?:movie-)?(\d+)$/.exec(s);
		if (movieMatch) return {
			mediaType: kind === "tv" || kind === "anime" || kind === "series" ? "tv" : "movie",
			externalId: movieMatch[1]
		};
	}
	return null;
}
function getNativePlatform() {
	...
	try {
		const p = window.ReelOSNative?.platform();
...
function generateDeepLink(provider, title, platform) {
	const meta = CANONICAL_PROVIDERS[provider.id];
	const webFallback = meta ? meta.getWebUrl(title) : `https://www.google.com/search?q=watch+${encodeURIComponent(title)}+${encodeURIComponent(provider.name)}`;
	if (platform === "web" || !meta) return webFallback;
	const pkg = platform === "android-tv" ? meta.androidTvPackage || meta.androidMobilePackage : meta.androidMobilePackage;
	if (!pkg) return webFallback;
	return `intent://${webFallback.replace(/^https?:\/\//, "")}#Intent;scheme=https;package=${pkg};action=android.intent.action.VIEW;S.browser_fallback_url=${encodeURIComponent(webFallback)};end`;
}
function StreamingAvailabilityBar({ titleId, titleName, kind, extraIds = [], className }) {
	const identity = (0, import_react.useMemo)(() => resolveTmdbIdentity(titleId, kind, extraIds), [
		titleId,
		kind,
		extraIds
	]);
	...
	const platform = (0, import_react.useMemo)(getNativePlatform, []);
	(0, import_react.useEffect)(() => {
		if (!identity) {
			setLoading(false);
			return;
	...
	if (loading) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("flex flex-wrap items-center gap-2.5 py-2 animate-pulse", className),
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-11 w-40 rounded-2xl bg-card/60 border border-border" }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "h-11 w-32 rounded-2xl bg-card/60 border border-border" })]
	});
	if (!data?.available) {
		if (data?.reason === "not_configured") return null;
		return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: cn("text-xs text-muted/60 py-1 font-serif italic tracking-wide", className),
			children: [
				"No active commercial streaming subscriptions listed in region ",
				data?.region || "US",
				"."
			]
		});
	...
	if (subscriptions.length === 0 && freeWithAds.length === 0 && !isMoviesEligible && rentOrBuy.length === 0) return null;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: cn("rounded-2xl border border-border/70 bg-card/40 p-3.5 shadow-sm space-y-3 backdrop-blur-sm", className),
		children: [
			subscriptions.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-wrap items-center gap-2.5",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
					className: "text-[11px] font-semibold tracking-wider uppercase text-gold/90 flex items-center gap-1.5 mr-1 font-serif",
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Film, { className: "size-3.5 text-gold" }), "Commercial Stream:"]
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						href: deepLink,
						target: platform === "web" ? "_blank" : void 0,
						rel: "noopener noreferrer",
						className: cn("inline-flex min-h-11 items-center gap-2 rounded-2xl px-4 text-xs font-bold transition-all shadow-md hover:scale-[1.02] active:scale-[0.98] cursor-pointer border border-white/10", !meta && "bg-card border-border text-foreground hover:border-gold/40"),
						style,
						title: `Watch ${titleName} on ${provider.name}`,
						children: [
							provider.logoUrl ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
								src: provider.logoUrl,
								alt: "",
								className: "size-5 rounded-md object-contain"
							}) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tv, { className: "size-4" }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Watch on ", meta?.name || provider.name] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "size-3 opacity-80 ml-0.5" })
						]
					}, `sub-${provider.id}`);
				})]
			}),
			(freeWithAds.length > 0 || isMoviesEligible) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-wrap items-center gap-2",
				children: [freeWithAds.map((provider) => {
					const deepLink = generateDeepLink(provider, titleName, platform);
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
						href: deepLink,
						target: platform === "web" ? "_blank" : void 0,
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: ["Free on ", provider.name] }),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "size-3 opacity-70" })
						]
					}, `free-${provider.id}`);
				}), isMoviesEligible && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("a", {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingBag, { className: "size-4 text-blue-400" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: "Movies Anywhere" }),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ExternalLink, { className: "size-3 opacity-70" })
					]
				})]
			}),
			rentOrBuy.length > 0 && subscriptions.length === 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "flex flex-wrap items-center gap-2 text-xs text-muted",
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Tag, { className: "size-3 text-muted" }),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
						...
						children: [...new Set(rentOrBuy.map((p) => p.name))].slice(0, 4).join(" · ")
					})
				]
			}),
			data.attribution && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "pt-1",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
					...
					children: data.attribution.text
				})
			})
		]
	});
...
function nativePlatform() {
	if (typeof window === "undefined") return "web";
	try {
		return window.ReelOSNative?.platform() || "web";
	} catch {
		return "web";
	}
}
function ProfileAura({ lightweight = false }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function visibleNavigation() {
	return nativePlatform() === "android-tv" ? NAV.filter(([id]) => id !== "books") : NAV;
}
...
function ReelOSWorld({ initialView = "home", initialDestination, initialSettingsGroup, initialCompanionLink }) {
	...
	const platform = (0, import_react.useMemo)(nativePlatform, []);
	...
	const openDestination = (0, import_react.useCallback)((destination) => {
	...
	const openTitle = (0, import_react.useCallback)((title) => openDestination({
		type: "title",
	...
	if (!profileAdapterReady) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProfileAura, { lightweight: tvPlatform }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
	...
	const activeColor = !state.onboardingComplete && state.setupDraft?.color ? state.setupDraft.color : profile.color || "#d4a017";
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ProfileAura, { lightweight: tvPlatform }),
...
function Shell({ view, profile, profiles, kidsPresent, profileOpen, onProfileOpen, onNavigate, onSearch, onProfile, onKids, onProtectedNavigate }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", {
		className: `reelos-world-header top-0 z-40 w-full px-5 md:px-10 ${view === "home" ? "absolute border-transparent bg-transparent" : `sticky border-b border-white/[.07] bg-[#080809]/92 ${tvPlatform ? "" : "backdrop-blur-2xl"}`}`,
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", {
					className: `${tvPlatform ? "flex" : "hidden lg:flex"} items-center gap-1`,
					"aria-label": "Primary",
					children: navigation.map(([id, label, Icon]) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						profileOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							className: `absolute right-0 top-14 max-h-[calc(100dvh-10rem)] w-[min(350px,calc(100vw-32px))] overflow-y-auto overscroll-contain rounded-[1.6rem] border border-white/12 bg-[#141419]/96 p-3 shadow-2xl ${tvPlatform ? "" : "backdrop-blur-2xl"}`,
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
...
var PosterCard = (0, import_react.memo)(function PosterCard({ title, onOpen, className = "" }) {
...
function Shelf({ title, note, items, onOpen, onSeeAll }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			className: `reelos-poster-row gap-3 ${tvPlatform ? "grid grid-cols-6 overflow-visible" : "-mx-5 flex snap-x snap-mandatory overflow-x-auto px-5 pb-2 md:-mx-10 md:px-10 lg:mx-0 lg:grid lg:grid-cols-6 lg:overflow-visible lg:px-0 lg:pb-0"}`,
			children: items.slice(0, 6).map((item) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PosterCard, {
				title: item,
				onOpen,
				className: tvPlatform ? "w-auto max-w-none" : "w-[44vw] max-w-52 shrink-0 snap-start sm:w-[30vw] lg:w-auto lg:max-w-none"
			}, item.id))
		})]
	});
}
...
function NoIdeaChooser({ profile, titles, debrid, kidsPresent, onOpen, onPlay, onDiscover }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "reelos-no-idea relative min-h-[24rem] overflow-hidden rounded-[2rem] border border-white/10 bg-white/[.025] px-6 py-8 md:px-10 md:py-10",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "relative z-10 max-w-2xl",
			children: [
				stage === "idle" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
						className: "font-display text-[clamp(2.2rem,4vw,3.8rem)] font-semibold leading-[.92] tracking-[-.06em]",
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [[
			...
			return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				children: colTitles.map((title, itemIdx) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("img", {
					src: title.poster,
					alt: "",
					loading: "lazy",
					decoding: "async",
					className: "aspect-[.68] w-full rounded-2xl object-cover shadow-2xl"
				}, `${title.id}-${colIndex}-${itemIdx}`))
			}, colIndex);
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "absolute inset-0 bg-gradient-to-r from-[#0c0c0f] via-transparent to-transparent pointer-events-none" })]
	});
}
function DiscoverWorld({ profile, titles, onOpen, onSearch, onRefine, onPerson, onCollection }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("main", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "relative overflow-hidden rounded-[2rem] border border-white/8 bg-gradient-to-b from-white/[.04] to-black/60 p-8 md:p-12",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative z-10 max-w-xl",
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "text-sm font-semibold text-[var(--reelos-favorite,#d4a017)]",
							children: "Endless Cinema"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							className: "mt-2 font-display text-4xl font-bold tracking-tight md:text-5xl",
							children: "Still looking for the right note?"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-3 text-base text-white/60 leading-relaxed",
							children: "ReelOS continuously watches the edges of cinema. Tell it how tonight feels, or let the current pull you into something unexpected."
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
								...
								children: "Refine tonight’s temperature"
							})]
						})
					]
				}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FallingArtwork, { titles })]
			})
		]
	});
}
...
function SetupWorld({ onNavigate, onComplete }) {
	...
	const [device, setDevice] = (0, import_react.useState)(draft.device ?? (nativePlatform() === "android-tv" ? "tv" : "phone"));
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					query.trim() && !loading && !hasAny ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EmptyState, {
						...
						children: results.slice(0, tvPlatform ? 12 : 24).map((title) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PosterCard, {
							title,
							onOpen
						}, title.id))
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					...
					children: "This home can guide setup without sending your question away. Private local conversation becomes available only when this machine has an approved local speech package."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("input", {
					value: prompt,
...
function WhereToWatch({ title }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
		"aria-label": "Commercial stream and broadcast availability",
		className: "pt-2",
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(StreamingAvailabilityBar, {
			titleId: title.id,
