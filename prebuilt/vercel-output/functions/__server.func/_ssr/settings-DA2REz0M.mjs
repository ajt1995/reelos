...
import { i as adapterProfile, n as HOSTNAME } from "./appliance-BH_6H5H0.mjs";
import { A as Check, C as Cpu, D as ChevronRight, N as Bell, a as SlidersHorizontal, b as HardDrive, l as ScrollText, m as LoaderCircle, n as Users, o as Shield, r as TriangleAlert, t as Wrench, u as RefreshCw, v as KeyRound, y as House } from "../_libs/lucide-react.mjs";
import { a as CHANNEL, c as accessLabel, d as sourceLabel, f as storageLabel, l as frontendLabel, o as SHIPPED_VERSION, p as useReelStore, s as UPDATE_NOTES, u as qualityLabel } from "./router-DvmzfdIa.mjs";
import { d as formatWhen, i as Gate, l as cn, n as Button } from "./gate-BI3T0Pqc.mjs";
import { a as persistUi, i as Toggle, n as Section, r as TerminalRow, t as Row } from "./settings-terminal-BsmRJ9v_.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-DA2REz0M.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cpu, { className: "mt-0.5 size-5 text-muted" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				className: "mt-1 text-sm text-muted",
				children: "Caps transcode to one thread when a GPU (/dev/dri) is present. No GPU: Jellyfin DirectPlay/DirectStream only — no CPU ffmpeg transcode. Scene previews and subtitle extraction stay off so Jellyfin does not read TorBox dumps. A box with ≤4.5Gi MemTotal stays in this mode even if the toggle is off."
			})] })]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
			variant: low ? "circuit" : "ghost",
			onClick: () => void toggle(),
			disabled: busy,
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
			...
			children: [
				...
				className: cn("h-8 rounded-full px-3 text-sm", answers.intent[k] ? "bg-circuit/15 text-circuit shadow-[var(--shadow-circuit)]" : "bg-card-2 text-muted"),
				children: label
			}, k))
		}),
...
function QualityPanel() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
		...
		children: [
			...
			className: cn("h-8 rounded-full px-3 text-sm", answers.quality === q ? "bg-circuit/15 text-circuit shadow-[var(--shadow-circuit)]" : "bg-card-2 text-muted"),
...
function UpdatesRow({ open, onClick }) {
	...
	const hint = update.status === "applying" ? `Applying ${update.target ?? ""}` : update.status === "available" ? `${update.target} is ready` : update.status === "checking" ? betaChannel ? "Checking the beta channel" : "Checking the stable channel" : update.status === "current" ? `${installed} · up to date` : `${installed} · ${betaChannel ? "beta" : CHANNEL}`;
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Row, {
		icon: RefreshCw,
		title: "Updates",
		hint,
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-2 text-sm text-muted",
				children: update.status === "applying" ? "An Apply is running — phone, CLI, or both. Home can open. Engines are still configuring. Do not tap Apply again." : "Host patches from Ubuntu, ReelOS from GitHub. Stack images stay frozen unless you flip the toggle. Libraries stay put."
			}),
			...
			update.status === "applying" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ol", {
				...
				children: update.steps.map((s) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
					...
					children: [s.status === "done" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Check, {
						className: "mt-0.5 size-3.5 text-circuit",
						strokeWidth: 3
					}) : s.status === "running" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(LoaderCircle, { className: "mt-0.5 size-3.5 animate-spin text-circuit" }) : /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "mt-1.5 size-1.5 rounded-full bg-faint/40" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-2 text-xs text-muted",
				children: "Off by default. Check then reads channel-beta. Arena chrome and Books ship on 1.2.50.38-beta.1. Stable Check stays 1.2.50.38 on main.tar.gz."
			})
		]
	});
}
