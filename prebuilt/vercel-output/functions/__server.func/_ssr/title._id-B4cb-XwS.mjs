...
import { C as requestTitleIdForPage, D as titleMatchesId, O as titlePresenceKeys, S as requestShowsRetry, T as showRequestQueueControls, m as applyTitleRequestPoll, n as Route, p as useReelStore, w as showHashAdapter, x as requestMediaTypeForPage } from "./router-B2ojDOqc.mjs";
import { a as Poster, f as jellyfinWatchHref, i as Gate, n as Button, o as RemoveFromBox, u as formatRuntime } from "./gate-Dr2yZ4vF.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/title._id-B4cb-XwS.js
	...
	(0, import_react.useEffect)(() => {
		...
		fetch("/api/library", {
			...
			if (hit) {
				...
				if (disk.length) setOnDiskSeasons((cur) => [.../* @__PURE__ */ new Set([...cur, ...disk])].sort((a, b) => a - b));
			}
