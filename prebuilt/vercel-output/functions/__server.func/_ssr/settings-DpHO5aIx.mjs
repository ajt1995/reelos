...
import { a as CHANNEL, c as accessLabel, d as sourceLabel, f as storageLabel, l as frontendLabel, o as SHIPPED_VERSION, p as useReelStore, s as UPDATE_NOTES, u as qualityLabel } from "./router-Cp4LdwvY.mjs";
import { d as formatWhen, i as Gate, l as cn, n as Button } from "./gate-CcSTcre4.mjs";
import { a as persistUi, i as Toggle, n as Section, r as TerminalRow, t as Row } from "./settings-terminal-DELqeDaW.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/settings-DpHO5aIx.js
...
function UpdatesRow({ open, onClick }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Row, {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "mt-2 text-xs text-muted",
				children: "Off by default. Check then reads channel-beta. Arena chrome and Books ship on 2.0.0 as a separate tarball — not inside main.tar.gz. Leave beta and Check to roll back to last stable 1.2.50.x (39 once this house has it). Stable Check stays 1.2.50.39 on main.tar.gz."
			}),
