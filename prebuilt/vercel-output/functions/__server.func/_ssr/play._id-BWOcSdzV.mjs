...
import { o as getTitle } from "./appliance-BpvQVhxl.mjs";
import { p as useReelStore, r as Route$2, x as titleMatchesId } from "./router-Cp4LdwvY.mjs";
import { i as Gate } from "./gate-CcSTcre4.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/play._id-BWOcSdzV.js
...
function PlayerView({ id }) {
	...
	(0, import_react.useEffect)(() => {
		...
		const dest = jfId ? `http://${host}:8096/web/#/details?id=${encodeURIComponent(jfId)}` : `http://${host}:8096`;
