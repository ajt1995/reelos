...
import { P as Check, g as Play, h as Plus, o as ThumbsUp, s as ThumbsDown } from "../_libs/lucide-react.mjs";
import { C as requestShowsRetry, E as showRequestQueueControls, O as titleMatchesId, S as requestMediaTypeForPage, T as showHashAdapter, g as applyTitleRequestPoll, h as useReelStore, k as titlePresenceKeys, n as Route, w as requestTitleIdForPage } from "./router-DJXQsDxk.mjs";
import { a as Poster, c as TitleCard, f as jellyfinWatchHref, i as Gate, n as Button, o as RemoveFromBox, s as Row, u as formatRuntime } from "./gate-hkGl6LFk.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/title._id-DfqDUT5h.js
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThumbsUp, { className: "size-4" }), "Like"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
									size: "sm",
									...
									children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(ThumbsDown, { className: "size-4" }), "Dislike"]
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "self-center text-xs text-faint",
									children: "This profile only. Not a Google TV scrape."
								})
							]
						}),
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								available && canRemove ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RemoveFromBox, { title: resolved }) : null,
								...
								}) : !canRequest ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "self-center text-sm text-muted",
									children: "This profile cannot request titles."
