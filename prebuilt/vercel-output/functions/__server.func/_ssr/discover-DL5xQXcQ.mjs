...
import { f as Search, o as ThumbsUp, s as ThumbsDown } from "../_libs/lucide-react.mjs";
import { T as titleForRequest, g as inFlightRequests, h as collapseHomeRequestCards, p as useReelStore } from "./router-DQUzmDOi.mjs";
import { a as Gate, c as Row, g as useSyncRequests, l as TitleCard, m as useHouseholdProfile, u as cn } from "./gate-CTesRm1X.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/discover-DL5xQXcQ.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			q.trim().length >= 2 ? hits.length > 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
				label: "Results",
				children: hits.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DiscoverTitleCard, {
					title: t,
					vote: votes[t.id],
					onVote: vote
				}, t.id))
...
function DiscoverKind({ heading, onBox, finishing, pick, votes, onVote }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			pick.length ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Row, {
				label: "Pick tonight",
				children: pick.filter((t) => votes[t.id] !== "down").map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(DiscoverTitleCard, {
					title: t,
					vote: votes[t.id],
					onVote
				}, t.id))
...
function DiscoverTitleCard({ title, vote, onVote }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(TitleCard, {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				type: "button",
				"aria-label": "Like",
				className: cn("flex h-8 flex-1 items-center justify-center rounded-lg bg-card-2", vote === "up" && "bg-gold text-gold-fg"),
				onClick: (e) => {
					e.preventDefault();
					e.stopPropagation();
					onVote(title.id, "up");
				...
				type: "button",
				"aria-label": "Dislike",
				className: cn("flex h-8 flex-1 items-center justify-center rounded-lg bg-card-2", vote === "down" && "bg-danger/20 text-danger"),
				onClick: (e) => {
					e.preventDefault();
					e.stopPropagation();
