...
function SeasonEpisodeAccordion({ seasonNumbers, selectedSeason, onSelectSeason, diskSeasons, importingSeasons, unreleasedSeasons, titleId, seasonsLoading, seasonErr, onRetrySeasons, blocked, removedHere, onRequestSeason, onRequestEpisode }) {
	...
	const thisImporting = Boolean(importingSeasons?.includes(selectedSeason)) && !diskSeasons.includes(selectedSeason) && !thisUnreleased;
	const showSeasonRequest = !blocked && !thisUnreleased && !thisImporting && (removedHere || missing.length > 0 || open && !loading && episodes.length === 0);
