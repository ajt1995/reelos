...
import { a as cacheCopy, c as rememberCatalogTitles, o as getTitle, s as kindLabel } from "./appliance-BH_6H5H0.mjs";
import { A as Check, d as Plus, f as Play } from "../_libs/lucide-react.mjs";
import { m as applyTitleRequestPoll, n as Route, p as useReelStore, v as requestShowsRetry, y as showRequestQueueControls } from "./router-DvmzfdIa.mjs";
import { a as Poster, i as Gate, n as Button, o as RemoveFromBox, u as formatRuntime } from "./gate-BI3T0Pqc.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/title._id-C-PN2h-m.js
...
function TitleView({ id }) {
	...
	if (!resolved) return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
			...
			to: "/",
			className: "mt-4 inline-block text-circuit",
			children: "Home"
		})]
	});
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Poster, {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-xs tracking-[0.18em] text-circuit uppercase",
					...
					!available && !blocked && !request ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "mt-4 text-sm text-circuit",
					...
					resolved.kind === "tv" || resolved.kind === "anime" ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: seasonNumbers.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							type: "button",
							onClick: () => setSeason(n),
							className: season === n ? "h-9 rounded-full bg-circuit/20 px-3 text-xs text-circuit" : "h-9 rounded-full bg-card px-3 text-xs text-muted shadow-[var(--shadow-border)]",
							children: ["Season ", n]
						}, n))
					}) : null,
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							blocked ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								className: "inline-flex h-12 items-center rounded-2xl bg-card px-4 text-sm text-circuit",
