...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/router-DJXQsDxk.js
...
function isHouseOwner(role) {
	return role === "owner" || role === "admin";
}
function defaultPermissions(role, ageYears) {
	const owner = isHouseOwner(role);
	return {
		canRequest: owner || (ageYears == null ? 17 : ageYears) >= 7,
		autoApprove: owner,
		canApprove: owner,
...
var useReelStore = create()(persist((set, get) => ({
	...
	applyReadyPayload: (ready) => {
		...
		set((s) => {
			...
			return {
				...
				profileReady: ready?.session !== void 0 || s.profileReady
			};
		});
		const s = get();
		if (provisioned) {
	...
	requestTitle: (titleId, season) => {
		...
		const requester = s.users.find((u) => u.id === s.activeProfileId)?.name ?? s.users.find((u) => isHouseOwner(u.role))?.name ?? "Ada";
	...
	hydrateProfiles: async () => {
		try {
			...
			set({
				...
				taste: j.taste && Array.isArray(j.taste.likes) ? j.taste : {
					likes: [],
					dislikes: []
				},
				profileReady: true
	...
	setActiveProfile: (user, taste) => set({
	...
	signOutProfile: () => {
		fetch("/api/profiles/session", { method: "DELETE" }).catch(() => {});
		set({
			activeProfileId: null,
			taste: {
				likes: [],
...
var styles_default = "/assets/styles-BMj7w-w5.css";
var APP_NAME = "ReelOS";
...
var $$splitComponentImporter$13 = () => import("./routes-WDSjkhBu.mjs");
var Route$13 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$13, "component") });
var $$splitComponentImporter$12 = () => import("./activity-CvP-SdE9.mjs");
var Route$12 = createFileRoute("/activity")({ component: lazyRouteComponent($$splitComponentImporter$12, "component") });
var $$splitComponentImporter$11 = () => import("./books-J8isBBSw.mjs");
var Route$11 = createFileRoute("/books")({ component: lazyRouteComponent($$splitComponentImporter$11, "component") });
var $$splitComponentImporter$10 = () => import("./connect-BYW0KS__.mjs");
var Route$10 = createFileRoute("/connect")({ component: lazyRouteComponent($$splitComponentImporter$10, "component") });
var $$splitComponentImporter$9 = () => import("./discover-B9lqKlim.mjs");
var Route$9 = createFileRoute("/discover")({ component: lazyRouteComponent($$splitComponentImporter$9, "component") });
var $$splitComponentImporter$8 = () => import("./library-BawyaICI.mjs");
var Route$8 = createFileRoute("/library")({ component: lazyRouteComponent($$splitComponentImporter$8, "component") });
var $$splitComponentImporter$7 = () => import("./requests-C7dM6VRJ.mjs");
var Route$7 = createFileRoute("/requests")({ component: lazyRouteComponent($$splitComponentImporter$7, "component") });
var $$splitComponentImporter$6 = () => import("./settings-Bvv23T1s.mjs");
var Route$6 = createFileRoute("/settings")({ component: lazyRouteComponent($$splitComponentImporter$6, "component") });
var $$splitComponentImporter$5 = () => import("./collection._id-ClAykumN.mjs");
var Route$5 = createFileRoute("/collection/$id")({ component: lazyRouteComponent($$splitComponentImporter$5, "component") });
var $$splitComponentImporter$4 = () => import("./engine._id-Bhpjp-nm.mjs");
var Route$4 = createFileRoute("/engine/$id")({ component: lazyRouteComponent($$splitComponentImporter$4, "component") });
var $$splitComponentImporter$3 = () => import("./person._id-BdEaVW5d.mjs");
var Route$3 = createFileRoute("/person/$id")({ component: lazyRouteComponent($$splitComponentImporter$3, "component") });
var $$splitComponentImporter$2 = () => import("./play._id-DlGLa5o-.mjs");
var Route$2 = createFileRoute("/play/$id")({ component: lazyRouteComponent($$splitComponentImporter$2, "component") });
var $$splitComponentImporter$1 = () => import("./settings.advanced-DoAioTXB.mjs");
var Route$1 = createFileRoute("/settings/advanced")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./title._id-DfqDUT5h.mjs");
...
var ActivityRoute = Route$12.update({
	id: "/activity",
	path: "/activity",
	getParentRoute: () => Route$14
});
var BooksRoute = Route$11.update({
	id: "/books",
	path: "/books",
	getParentRoute: () => Route$14
});
var ConnectRoute = Route$10.update({
	id: "/connect",
	path: "/connect",
	getParentRoute: () => Route$14
});
...
var LibraryRoute = Route$8.update({
	id: "/library",
	path: "/library",
	getParentRoute: () => Route$14
});
var RequestsRoute = Route$7.update({
	id: "/requests",
	path: "/requests",
	getParentRoute: () => Route$14
});
...
var CollectionIdRoute = Route$5.update({
	id: "/collection/$id",
	path: "/collection/$id",
	getParentRoute: () => Route$14
});
...
//#endregion
export { transferringChipCount as A, requestShowsRetry as C, titleForRequest as D, showRequestQueueControls as E, OWNER_PERMISSION_TOGGLES as F, isHouseOwner as I, updateLocksUi as M, AGE_BANDS as N, titleMatchesId as O, MEMBER_WIZARD_QUESTIONS as P, requestMediaTypeForPage as S, showHashAdapter as T, collapseHomeRequestCards as _, Route$4 as a, mergeServerRequests as b, SHIPPED_VERSION as c, frontendLabel as d, qualityLabel as f, applyTitleRequestPoll as g, useReelStore as h, Route$3 as i, catchupLocksHome as j, titlePresenceKeys as k, UPDATE_NOTES as l, storageLabel as m, Route as n, Route$5 as o, sourceLabel as p, Route$2 as r, CHANNEL as s, router_exports as t, accessLabel as u, inFlightRequests as v, requestTitleIdForPage as w, overlayLibraryPresence as x, isGhostRequestLabel as y };
