...
import { a as CHANNEL, c as accessLabel, d as sourceLabel, f as storageLabel, k as catchupLocksHome, l as frontendLabel, o as SHIPPED_VERSION, p as useReelStore, s as UPDATE_NOTES, u as qualityLabel } from "./router-Bzg6a_G8.mjs";
import { d as formatWhen, i as Gate, l as cn, n as Button } from "./gate-BwjeEJFD.mjs";
import { a as persistUi, i as Toggle, n as Section, r as TerminalRow, t as Row } from "./settings-terminal-w4yNi6q8.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/settings-jn041dYH.js
...
function PerformanceRow() {
	...
	(0, import_react.useEffect)(() => {
		fetch("/api/performance", { cache: "no-store" }).then((r) => r.json()).then((j) => {
			setLow(j.low !== false);
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cpu, { className: "mt-0.5 size-5 text-muted" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mt-1 text-sm text-muted",
					children: probed ? "Detected on this box. Low-RAM / HDD boxes keep one TorBox filesystem, skip dump scans, and use compressed RAM instead of disk swap." : "A 4.5Gi RAM guess is used until the probe runs. This is not a speed test."
				}),
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
