...
import { i as adapterProfile, n as HOSTNAME } from "./appliance-DZSyqH7A.mjs";
...
import { a as CHANNEL, c as accessLabel, d as sourceLabel, f as storageLabel, l as frontendLabel, o as SHIPPED_VERSION, p as useReelStore, s as UPDATE_NOTES, u as qualityLabel } from "./router-Dz7ZmWyw.mjs";
import { d as formatWhen, i as Gate, l as cn, n as Button } from "./gate-CFzR9JKr.mjs";
import { a as persistUi, i as Toggle, n as Section, r as TerminalRow, t as Row } from "./settings-terminal-BwuYN16a.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/settings-CompZRhX.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Cpu, { className: "mt-0.5 size-5 text-muted" }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				...
				className: "mt-1 text-sm text-muted",
				children: "Caps transcode to one thread, throttles ffmpeg, and uses the GPU when present. Scene previews and subtitle extraction stay off so Jellyfin does not read TorBox dumps. Default on for a 4GB box."
			})] })]
