...
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/router-nhD3aa4s.js
...
var UPDATE_NOTES = [
	"1.2.50.51: Finished titles (Passengers) stay on Requests until they land on On this box with Watch — they do not vanish. The existing request poll refreshes the JF shelf; no second Home timer. Gold chrome, prebuilt hashed UI. 1.2.51 parked (was Tron chrome; scrapped — do not reuse).",
...
var styles_default = "/assets/styles-C9vPUmA6.css";
var APP_NAME = "ReelOS";
...
//#endregion
export { catchupLocksHome as A, requestTitleIdForPage as C, titleMatchesId as D, titleForRequest as E, titlePresenceKeys as O, requestShowsRetry as S, showRequestQueueControls as T, isGhostRequestLabel as _, CHANNEL as a, requestMediaTypeForPage as b, accessLabel as c, sourceLabel as d, storageLabel as f, inFlightRequests as g, collapseHomeRequestCards as h, Route$3 as i, updateLocksUi as j, transferringChipCount as k, frontendLabel as l, applyTitleRequestPoll as m, Route as n, SHIPPED_VERSION as o, useReelStore as p, Route$2 as r, UPDATE_NOTES as s, router_exports as t, qualityLabel as u, mergeServerRequests as v, showHashAdapter as w, requestNeedsLibraryHandoff as x, overlayLibraryPresence as y };
