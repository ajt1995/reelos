...
import { C as isTvRequestRow, L as tvSeasonChips, N as titleForRequest, O as requestProgressLabel, S as isGhostRequestLabel, _ as useReelStore, k as requestShowsRetry, x as inFlightRequests } from "./router-BN1QAJlL.mjs";
import { i as cn, o as formatWhen } from "./title-card-B87ltnBM.mjs";
import { n as useSyncRequests, t as useResolveGhostRequestTitles } from "./use-sync-requests-CNJ1Dx7t.mjs";
import { i as Gate, n as Button } from "./gate-CkPHXC_2.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/requests-uIM9U6fJ.js
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									chips.length > 1 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "mt-1 flex flex-wrap gap-x-2 text-xs text-muted",
										children: chips.map((c) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
											"S",
