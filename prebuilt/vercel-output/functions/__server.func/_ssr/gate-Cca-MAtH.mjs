...
import { _ as overlayLibraryPresence, b as titleForRequest, d as sourceLabel, g as mergeServerRequests, h as inFlightRequests, l as frontendLabel, p as useReelStore } from "./router-BUp0EPEh.mjs";
import { n as clsx, t as cva } from "../_libs/class-variance-authority+clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
import { t as Slot } from "../_libs/radix-ui__react-slot.mjs";
//#region ../../workspace/node_modules/.nitro/vite/services/ssr/assets/gate-Cca-MAtH.js
				...
				children: STEPS.map((step) => {
					...
					return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", {
							...
							className: "text-xs text-muted",
							children: step.id === "library" && catchup.splashLock ? catchup.message || "Library catching up" : stepLabel(status)
						})]
					}, step.id);
				})
