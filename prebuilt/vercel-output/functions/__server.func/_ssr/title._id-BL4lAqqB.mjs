...
import { P as Check, g as Play, h as Plus } from "../_libs/lucide-react.mjs";
import { C as showHashAdapter, D as titlePresenceKeys, E as titleMatchesId, S as requestTitleIdForPage, b as requestMediaTypeForPage, m as applyTitleRequestPoll, n as Route, p as useReelStore, w as showRequestQueueControls, x as requestShowsRetry } from "./router-DQUzmDOi.mjs";
import { a as Gate, d as formatRuntime, m as useHouseholdProfile, n as Button, o as Poster, p as jellyfinWatchHref, s as RemoveFromBox } from "./gate-CTesRm1X.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/title._id-BL4lAqqB.js
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							available && !kids ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(RemoveFromBox, { title: resolved }) : null,
							blocked ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								className: "self-center text-sm text-muted",
								children: "Kids profile cannot Request. Switch profiles in the header."
					...
					!available && !blocked && !kids && hashPaste ? /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", {
