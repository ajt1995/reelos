...
export const SOURCES: {
  ...
  { id: "torbox", name: "TorBox", blurb: "Validated directly, then connected through ReelOS.", mark: "TB" },
  { id: "real-debrid", name: "Real-Debrid", blurb: "Validated directly, then bridged through Decypharr.", mark: "RD" },
