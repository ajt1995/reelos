...
export const UPDATE_NOTES = [
  "1.2.50.21: Jellyfin Movies stays one poster after a library scan (native `Title (Year) - 1080p` / `- 2160p` names so 1080+4K are versions; extra 4Ks park; merge LAST). Hybrid Radarr grabs 1080 and 4K and keeps both (recycle the upgraded 1080, restore it next to 4K, cutoff MoviesSearch, interactive 1080 grab for existing 4K-only titles). Settings Fix runs named repairs (one poster, grab 1080, unstick, remount, rewire) with a short description each. Phone Home paints without waiting on /api/box; Library serves a stale shelf; posters go through a same-origin thumbnail. Never /media. Complements #72. Not 1.2.51 (Tron).",
