...
export const LATEST_VERSION = "1.2.50.23";
export const SHIPPED_VERSION = "1.2.50.23";
export const CHANNEL_URL = "https://raw.githubusercontent.com/ajt1995/reelos/main/channel.json";

export const UPDATE_NOTES = [
  "1.2.50.23: Phone shows Applying while mailman is still in hops (CLI Apply is not reelos-ota.service). Status uses the held ota.lock flock. /api/box no longer calls a slow VirtualFolders timeout Missing library. Settings auto-update no longer 500s when Vite cannot write systemd units. Shelf strips a trailing (Year) that matches ProductionYear. Complements #79. Not 1.2.51 (Tron).",
