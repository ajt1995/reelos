...
export const LATEST_VERSION = "1.2.50.25";
export const SHIPPED_VERSION = "1.2.50.25";
export const CHANNEL_URL = "https://raw.githubusercontent.com/ajt1995/reelos/main/channel.json";

export const UPDATE_NOTES = [
  "1.2.50.25: Jellyfin never extracts subtitles, trickplay, chapter images, or intro segments from TorBox dumps. Turning low-performance off does not re-enable those scans. Complements #82. Not 1.2.51 (Tron).",
