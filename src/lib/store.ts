...
export const UPDATE_NOTES = [
  "1.2.50.20: Apply parks release-named movie dumps (Interstellar.2014.2160p… / YTS folder) into Title (Year) so Jellyfin Movies is not Interstellar×3. Same allowlist as TV season-folder collapse — never /media. Complements #71 FUSE remount. Not 1.2.51 (Tron).",
