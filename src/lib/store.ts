...
export const UPDATE_NOTES = [
  "1.2.50.21: Jellyfin Movies stays one poster after a library scan (merge LAST; lock-clients re-merges every minute). Phone Home paints without waiting on /api/box; Library serves a stale shelf; posters go through a same-origin thumbnail. Never /media. Complements #72. Not 1.2.51 (Tron).",
