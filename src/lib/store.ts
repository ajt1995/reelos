...
export const LATEST_VERSION = "1.2.50.24";
export const SHIPPED_VERSION = "1.2.50.24";
export const CHANNEL_URL = "https://raw.githubusercontent.com/ajt1995/reelos/main/channel.json";

export const UPDATE_NOTES = [
  "1.2.50.24: Recover monitors unmonitored Seerr seasons and adds a missing Sonarr series before SeasonSearch. Home's first request poll sends recover=1 without blocking the list. Requests shows Retry when search will not run, and names rows from *arr. Complements #82. Not 1.2.51 (Tron).",
