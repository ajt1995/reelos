...
export function PersonView({ id }: { id: string }) {
  ...
  return (
    <div className="w-full px-6 md:px-12 lg:px-16 max-w-7xl mx-auto pb-16 pt-4">
      ...
      {!payload ? (
        ...
        <p className="mt-8 text-sm text-danger">{payload.error || "Could not find details for this artist."}</p>
      ) : (
        <>
