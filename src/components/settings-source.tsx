  ...
  return (
    <div>
      <p className="font-mono text-sm">
        ReelOS source connector
        <span className="ml-3 text-muted">{sourceLabel[answers.source]}</span>
      </p>
      <p className="mt-2 text-sm text-muted">ReelOS verifies availability before a title can be played or saved.</p>
