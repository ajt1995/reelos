...
const PHONE_NAV = NAV.filter((n) => n.to !== "/activity" && n.to !== "/settings");
        ...
        <nav className="flex flex-1 flex-col gap-0.5 px-3">
          {NAV.map((n) => {
            ...
            return (
              ...
              >
                <n.icon className={cn("size-4", on && "text-cyan")} />
                {n.label}
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                on ? "text-cyan" : "text-faint",
              )}
            >
              <n.icon className={cn("size-5", on && "drop-shadow-[0_0_8px_rgb(0_229_255_/_0.7)]")} />
              {n.label}
            </Link>
          );
        })}
