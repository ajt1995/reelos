...
2. Discover search: two random movies + two random TV shows from **2012–2016**. Real Seerr/TMDB hits — not empty shelves, not a silent AbortError.
...
5. `GET /api/request?recover=1` still works for empty TV seasons from 1.2.50.4.
