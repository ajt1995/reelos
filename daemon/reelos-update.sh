...
need daemon/reelos-selfheal.sh 'library catch-up deferred'
...
need daemon/relink_dumps.py 'strip_indexer_prefix'
need daemon/sonarr_manual_import.py 'THAT season already has files'
need daemon/stuck-downloads.py 'has not taken the files yet'
need daemon/stuck-downloads.py 'not restarting Sonarr or live Jellyfin'
...
need daemon/wire-engines.parts/00.part 'peel extra /mnt binds'
need daemon/wire-engines.parts/01.part 'not bind-stacking'
need daemon/wire-engines.parts/07.part 'stub_container_ffprobe'
need daemon/reelos-library-catchup.sh 'ffprobe stubbed'
...
need daemon/wire-engines.parts/09.part 'DirectPlay/DirectStream'
need daemon/wire-engines.parts/09.part 'has_vaapi_dri'
need daemon/wire-engines.parts/09.part 'persist_jellyfin_encoding_xml'
