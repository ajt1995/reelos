> [!WARNING]
> **HISTORICAL ARCHIVE ONLY — NOT SYSTEM GROUND TRUTH**
> This file is an archived risk assessment from early prototype development (September 9, 2026).
> Jellyfin, Docker, and the `*arr` stack discussed herein have been **PERMANENTLY RETIRED** and replaced by the ReelOS Neural Media Engine.
> For authoritative reality, consult [GROUND-TRUTH.md](../../../GROUND-TRUTH.md) and [THE-LAWS-OF-REELOS.md](../../THE-LAWS-OF-REELOS.md).

# ReelOS stack risk — #45 through #51 (ARCHIVED)
...
|---|---|---|---|
| 1 | [#45](https://github.com/reelos-org/reelos/pull/45) lockfile `npm ci` | **merged** | `package-lock.json` name=`reelos` |
| 2 | [#46](https://github.com/reelos-org/reelos/pull/46) lean cached `/api/library` | **merged** | token TTL + `serveLibrary` |
| 3 | [#47](https://github.com/reelos-org/reelos/pull/47) JF12 auth, unhide, Finish detach | **merged** | hop search 4× retry (still fail-closed then) |
| 4 | [#48](https://github.com/reelos-org/reelos/pull/48) OTA mailman stamp | **merged** | search hop **advisory**; lockfile `SKIP_NPM`; restore `.broken` |
| 5 | [#49](https://github.com/reelos-org/reelos/pull/49) Jellyfin durable seed | **merged** | stamp **1.2.49**; `network.xml` seed |
| 6 | [#50](https://github.com/reelos-org/reelos/pull/50) importPending / FUSE retry | **merged** `c3fa807` | also ENOTCONN-in-container / rslave heal / `reelos-mnt-rshared.service` |
| 7 | this PR [#51](https://github.com/reelos-org/reelos/pull/51) | overlay + smoke + **1.2.50** | **merge this** |
