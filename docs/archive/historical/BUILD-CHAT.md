...
> This file is an archived conversation log from early prototype development (September 8–11, 2026).
...
Hal: push real source to `reelos-org/reelos` (`iso/`, `ui/`, `firstboot/`, `compose/`, `daemon/`). Don’t commit ISOs or keys.
