...
| Issue | PR | Branch |
| ----- | -- | ------ |
| #8 version chrome | [#11](https://github.com/reelos-org/reelos/pull/11) | `feature/8-version-chrome` |
| #7 Tailscale login | [#12](https://github.com/reelos-org/reelos/pull/12) | `feature/7-tailscale` |
| #10 quality upgrades | [#13](https://github.com/reelos-org/reelos/pull/13) | `feature/10-quality-upgrades` |
...
- Windows Setup (`ReelOS-Setup.exe`): Flash USB or direct VM deploy ([`docs/TICKET-WINDOWS-INSTALLER.md`](docs/TICKET-WINDOWS-INSTALLER.md))

## Parked

- FACELIFT
- #9 after #3/#4
- [#14 idea drawer](https://github.com/reelos-org/reelos/issues/14) — 18 later features. Do not implement.
