...
export const APPLY_STAGE_COUNT = 6;
export const DOWNLOAD_STALL_MS = 120_000;

export const APPLY_STAGES = [
  { id: "probe", index: 1, label: "Checking" },
  { id: "download", index: 2, label: "Downloading" },
  { id: "extract", index: 3, label: "Verifying" },
  { id: "door", index: 4, label: "Staging" },
  { id: "health", index: 5, label: "Health Probe" },
  { id: "done", index: 6, label: "Complete/Rollback" },
];
