...
test("GNU cp onto itself is the firstboot loop (HERE==ROOT)", (t) => {
  if (process.platform === "win32") {
    t.skip("Requires POSIX cp");
    return;
  }
...
test("provisioned firstboot path stamps stack-installed and exits 0 without apt", (t) => {
  if (process.platform === "win32") {
