...
test("provision, self-heal, Settings, doctor, reset persist DirectPlay path", () => {
  ...
  assert.match(read("src/components/settings-panels.tsx"), /plays compatible originals and existing renditions only/);
  assert.match(read("src/components/settings-panels.tsx"), /Keeps video conversion to one task/);
  assert.match(read("src/components/settings-panels.tsx"), /Background previews and subtitle extraction pause/);
